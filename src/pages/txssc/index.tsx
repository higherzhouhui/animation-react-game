      ...
      {loading ? (
        ...
        <div className={style.table}>
          ...
          <div className={style.tabelGrid} id="tabelGrid" style={{ width: tabelGrid.width > 0 ? tabelGrid.width : "100%", height: tabelGrid.height > 0 ? tabelGrid.height : "100%" }}>
            <img
              src={require("@/assets/image/txssc/background/game-table.png")}
              alt=""
            ...
            <div
              ...
              style={{
                width: `${tabelGrid.width * 0.85}px`,
                height: `${tabelGrid.height * 0.67}px`,
                paddingTop: `${tabelGrid.height * 0.1}px`,
              }}>
              ...
              <div
                className={style.disableGrid}
                style={{
                  width: "100%",
                  height: `${tabelGrid.height * 0.1}px`,
                }}
                onClick={() => false}></div>
            </div>
          </div>
          {/* 筹码盘 */}
          <Chip grid={"tabelArea0"} offsetTop={(document.documentElement.clientHeight - tabelGrid.height) / 2} ref={ChipRef} downTime={downTime} moneySelectList={moneySelectList} type="txssc" chipPoint={lastRecord.lotteryResult} gameItem={gameArray} lotteryName={lotteryName} betAble={betAble} betAbleSet={betAbleSet} expect={issueData.expect} hasVer />
          {/* 游戏规则 */}
