        ...
        <div className={style.table}>
          ...
          <div className={style.rightTop}>
            <div className={style.result}>
              ...
              <YflhcIcon array={lastRecord.lotteryResult} />
            </div>
            <GameClose />
          </div>
          {/* 左边 */}
          ...
          <div className={style.tabelGrid} id="tabelGrid" style={{ width: tabelGrid.width > 0 ? tabelGrid.width : "100%", height: tabelGrid.height > 0 ? tabelGrid.height : "100%" }}>
            <img
              src={require("@/assets/image/yflhc/background/game-table.png")}
              alt=""
          ...
          {/* 筹码盘 */}
          <Chip grid={"tabelArea0"} offsetTop={(document.documentElement.clientHeight - tabelGrid.height) / 2} ref={ChipRef} downTime={downTime} moneySelectList={moneySelectList} type={lotteryName} chipPoint={lastRecord.lotteryResult} gameItem={gameArray} lotteryName={lotteryName} betAble={betAble} betAbleSet={betAbleSet} expect={issueData.expect} hasVer />
          {/* 游戏规则 */}
